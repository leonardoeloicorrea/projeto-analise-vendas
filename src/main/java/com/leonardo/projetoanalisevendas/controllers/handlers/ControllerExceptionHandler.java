package com.leonardo.projetoanalisevendas.controllers.handlers;
...
import com.leonardo.projetoanalisevendas.dtos.CustomErrorDTO;
import com.leonardo.projetoanalisevendas.dtos.FieldMessageDTO;
import com.leonardo.projetoanalisevendas.dtos.ValidationErrorDTO;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomErrorDTO> methodArgumentNotValid(MethodArgumentNotValidException e, HttpServletRequest request){
        ...
        ValidationErrorDTO error = new ValidationErrorDTO(LocalDateTime.now(), status.value(), "Invalid data", request.getRequestURI());
